...
public class AttendanceController {
	...
	@GetMapping(value="/attendance/page/{page}", produces="application/json")
	...
	public ResponseEntity<Object> getAttendacneByNo(@PathVariable(value="attNo", required=false) Optional<String> opt) {
