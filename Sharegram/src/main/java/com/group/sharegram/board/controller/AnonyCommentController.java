...
public class AnonyCommentController {
	...
	public Map<String, Object> add(AnonyCommentDTO comment, HttpServletRequest request) {
	...
	public Map<String, Object> replyAdd(AnonyCommentDTO reply, HttpServletRequest request){
