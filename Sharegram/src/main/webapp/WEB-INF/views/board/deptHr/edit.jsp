...
<style>
	...
	<div class="deptEdit">
		...
		<form id="frm_dept" action="${contextPath}/board/deptHr/modify" method="post">
			...
			<div>
				<input type="text" name="boardTitle"  class="inputBox" size=98 required="required" value="${deptHrBoard.boardTitle}">
			</div>
