...
<%-- <jsp:include page="../layout/header.jsp">
	...
	<div>
		...
		<form id="frm_notic" action="${contextPath}/board/free/modify" method="post">
			...
			<div>
				<textarea rows="8" cols="30" name="noticContent" id="noticContent" required>${n.noticContent}</textarea>
			</div>
			<div>
				<button>수정완료</button>
				<input type="reset" value="입력초기화">
				<input type="button" value="게시판으로가기" onclick="location.href='${contextPath}/board/free/modify'">
			</div>
		</form>
	</div>
